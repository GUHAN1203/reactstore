  ...
  return (
    <div className="row g-0 bg-light" style={{ alignItems: "flex-start" }}>
      <div
        ...
        style={{ height: "25vh", position: "sticky", top: "0" }}
      >
        <img
          style={{ backgroundColor: " rgb(235, 238, 228)" }}
      ...
      <div className="col-md-6 p-5 ps-md-0  ">
        ...
        <p style={{ color: "rgb(139, 143, 147)" }}>
          Marble Odyssey 16 GB RAM + 256 GB Storage
        </p>
        <h3>₹64,999</h3>
        <p style={{ color: " rgb(139, 143, 147)" }}>
          M.R.P. ₹64,999 (inclusive of all taxes)
        </p>
        <hr />

        <div className="col-md-6  ps-md-0">
          <h4>Color:MarbleOdyssey </h4>
          <img style={{ width: "50px" }} src="nsdfghj" alt=" Oneplus 11 5G" />
        </div>
        <hr />
        ...
        <div>
          ...
          <ul>
            ...
            <li>
              Link your OnePlus device to Red Cable Club and get ₹2000 off
              coupon on select variants
            </li>
            <li>Get 6 months of Spotify Premium for Free.</li>
            <li>
              Get 6 months of 100GB Google One cloud storage, and up to 6 months
              of YouTube Premium on us.
            </li>
            <li>Save up to 18% on business purchases.</li>
            <li>Free Gift (1/1)</li>
          </ul>
        </div>
        ...
        <div
          style={{ width: "100" }}
          className="col-md-6 mb-md-0 p-md-4 w-100% "
        >
          <button
            style={{ backgroundColor: "rgb(255, 6, 6)", color: "aliceblue" }}
          >
            Buy Now
          </button>
          <button
            style={{ backgroundColor: "rgb(0, 0, 0)", color: "aliceblue" }}
          >
            Add to Cart
          </button>
        </div>
